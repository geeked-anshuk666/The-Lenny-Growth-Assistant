...
- [⚡ Quickstart (Reproducible Setup Guide)](#-quickstart-reproducible-setup-guide)
  - [Method 1: Docker Desktop Setup (Recommended)](#method-1-docker-desktop-setup-recommended)
  - [Method 2: Manual Setup (Bare-Metal)](#method-2-manual-setup-bare-metal--local-development)
- [🛠️ Tech Stack Overview](#️-tech-stack-overview)
- [Why This Stack](#why-this-stack)
- [Prerequisites](#prerequisites)
- [Running Tests](#running-tests)
- [Troubleshooting](#troubleshooting)
- [🏗️ Architecture Decisions & Tech Stack Rationale](#️-architecture-decisions--tech-stack-rationale)
- [⚖️ Trade-offs & Real Engineering Solutions](#️-trade-offs--real-engineering-solutions)
- [🚫 Out of Scope](#-out-of-scope-currently)
...
| **Groq API key** | Get from [consolegroq.com](https://console.groq.com) |
